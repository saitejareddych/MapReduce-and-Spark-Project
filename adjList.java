...
public class adjList {
	...
	Text temp_key_min = new Text("");
        ...
        public void reduce(Text key, Iterable<Text> values,
            ...
            if(cntr>count_max){
                count_max=cntr;
                result.set(adjlst);
		result_max.set("This Node has Maximum Connectivity with "+count_max+" Connections for DIRECTED GRAPH");
                temp_key.set(key);
            }
	    if(count_min>cntr){
		count_min= cntr;
		result_min.set("This Node has Minimum Connectivity with "+count_min+" Connections for DIRECTED GRAPH");
	...
	if(cntr>count_max){
                count_max=cntr;
                result.set(adjlst);
                result_max.set("This Node has Maximum Connectivity with "+count_max+" Connections for UNDIRECTED GRAPH");
                temp_key.set(key);
            }
            if(count_min>cntr){
                count_min= cntr;
                result_min.set("This Node has Minimum Connectivity with "+count_min+" Connections for UNDIRECTED GRAPH");
                temp_key_min.set(key);
        }
